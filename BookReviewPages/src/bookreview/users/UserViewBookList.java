...
@WebServlet("/UserViewBookList")
public class UserViewBookList extends HttpServlet 
{
	private static final long serialVersionUID = 1L;

	private Logger log = Logger.getLogger("<UserViewBookList>logger");

	ServletContext ctx;
	Connection con ;
	ResultSet rs;

	public UserViewBookList() 
	{
		log.info("In Constroouctor UserViewList");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			PreparedStatement ps;	//creating instance of preparedstatement
